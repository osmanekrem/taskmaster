 ...
 */
export const securityLevelMemberTypeEnum = pgEnum(
  'security_level_member_type',
  [
    'user', // Specific user
    'group', // User group
 ...
 */
export const securityLevels = pgTable(
  'security_levels',
  {
    id: text('id')
      .primaryKey()
 ...
 */
export const securityLevelMembers = pgTable(
  ...
  (table) => [
    ...
    index('security_level_members_member_idx').on(
      table.memberType,
      table.memberId,
    ),
  ],
 ...
 */
export const projectSecuritySchemes = pgTable(
  'project_security_schemes',
  {
    id: text('id')
      .primaryKey()
      .$defaultFn(() => crypto.randomUUID()),
     ...
     */
    defaultLevelId: text('default_level_id').references(
      () => securityLevels.id,
      { onDelete: 'set null' },
    ),
...
export const issueSecuritySchemesRelations = relations(
...
export const securityLevelsRelations = relations(
  securityLevels,
  ({ one, many }) => ({
...
export const securityLevelMembersRelations = relations(
...
export const projectSecuritySchemesRelations = relations(
...
export type InsertIssueSecurityScheme =
  typeof issueSecuritySchemes.$inferInsert;
...
export type InsertSecurityLevelMember =
  typeof securityLevelMembers.$inferInsert;

export type ProjectSecurityScheme = typeof projectSecuritySchemes.$inferSelect;
export type InsertProjectSecurityScheme =
  typeof projectSecuritySchemes.$inferInsert;

export type SecurityLevelMemberType =
  (typeof securityLevelMemberTypeEnum.enumValues)[number];
