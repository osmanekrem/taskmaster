import {pgTable, text, timestamp, integer, jsonb, boolean, unique, index} from "drizzle-orm/pg-core";
 ...
 */
export const sprintHistory = pgTable("sprint_history", {
	id: text("id")
		.primaryKey()
		.$defaultFn(() => crypto.randomUUID()),
 ...
 */
export const sprintBurndown = pgTable("sprint_burndown", {
	id: text("id")
		.primaryKey()
		.$defaultFn(() => crypto.randomUUID()),
